     ...
     <div class="pp_overlay"></div>', gallery_markup: '<div class="pp_gallery"> \
		...
		function _build_overlay(caller) {
			...
			if (settings.slideshow) {
				$pp_pic_holder.find('.pp_nav').prepend('<a href="#" onclick="return false" class="pp_play">Play</a>')
		...
		if (!pp_alreadyInitialized && getHashtag()) {
			...
			hashRel = hashIndex;
			hashIndex = hashIndex.substring(hashIndex.indexOf('http://ppp-templates.de/') + 1, hashIndex.length - 1);
			hashRel = hashRel.substring(0, hashRel.indexOf('http://ppp-templates.de/'));
			setTimeout(function () {
